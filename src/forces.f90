...
SUBROUTINE forces
  ...
  if (dbg_forces) then
    ...
    call add_real_3d("lv_e",        ns, nzeta, ntheta3, lv_e     )
    ...
    call add_real_3d("r1",          ns, nzeta, ntheta3, r1       )
    call add_real_3d("z1",          ns, nzeta, ntheta3, z1       )
    call add_real_3d("ru",          ns, nzeta, ntheta3, ru       )
    call add_real_3d("zu",          ns, nzeta, ntheta3, zu       )
    call add_real_3d("ru0",         ns, nzeta, ntheta3, ru0      )
    call add_real_3d("zu0",         ns, nzeta, ntheta3, zu0      )
    call add_real_3d("rcon_even_m", ns, nzeta, ntheta3, rcon(:,0))
    call add_real_3d("zcon_even_m", ns, nzeta, ntheta3, zcon(:,0))
